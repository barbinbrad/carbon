...
VALUES 
  ...
  ('85020', 'Inventory Invoiced Not Received', 'Posting', 'cjgo71si60lg1aoj5p4g', NULL, 'Balance Sheet', 'Credit', 'Average', true, true, 'system'),
  ...
  ('92210', 'Prepayments', 'Posting', 'cjgo71si60lg1aoj5p80', NULL, 'Balance Sheet', 'Credit', 'Average', true, true, 'system'),
  ('93005', 'Payables', 'Posting', 'cjgo71si60lg1aoj5p7g', NULL, 'Balance Sheet', 'Credit', 'Average', true, true, 'system'),
  ('93010', 'Inventory Received Not Invoiced', 'Posting', 'cjgo71si60lg1aoj5p80', NULL, 'Balance Sheet', 'Credit', 'Average', true, true, 'system'),
  ('93110', 'Inventory Shipped Not Invoiced', 'Posting', 'cjgo71si60lg1aoj5p80', NULL, 'Balance Sheet', 'Debit', 'Average', true, true, 'system'),
  ('94100', 'Sales Tax Payable', 'Posting', 'cjgo71si60lg1aoj5p80', NULL, 'Balance Sheet', 'Credit', 'Average', true, true, 'system'),
  ('94110', 'Purchase Tax Payable', 'Posting', 'cjgo71si60lg1aoj5p80', NULL, 'Balance Sheet', 'Credit', 'Average', true, true, 'system'),
